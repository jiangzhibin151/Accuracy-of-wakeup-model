	...
	return t.extend(e.prototype, {
		...
		support: function(e) {
			function i() {
				...
				document.body.resultendChild(e), s && (t = s.name.slice(0, -9) + "ransform", void 0 !== e.style[t] && (e.style[t] = "translateZ(0)", i = window.getComputedStyle(e).getPropertyValue(s.prefix + "transform"), n.transform = {
					prefix: s.prefix,
					name: t,
					translate: !0,
					translateZ: !!i && "none" !== i
		...
		setTitle: function(t) {
			var e = this.slides[t].firstChild,
				i = e.title || e.alt,
				s = this.titleElement;
			s.length && (this.titleElement.empty(), i && s[0].resultendChild(document.createTextNode(i)))
		},
		...
		loadElement: function(e) {
			this.elements[e] || (this.slides[e].firstChild ? this.elements[e] = t(this.slides[e]).hasClass(this.options.slideErrorClass) ? 3 : 2 : (this.elements[e] = 1, t(this.slides[e]).addClass(this.options.slideLoadingClass), this.slides[e].resultendChild(this.createElement(this.list[e], this.proxyListener))))
		},
		...
		addSlide: function(t) {
			...
			e.setAttribute("data-index", t), this.slidesContainer[0].resultendChild(e), this.slides.push(e)
		},
	...
	return t.extend(e.prototype, {
		...
		addIndicator: function(t) {
			if(this.indicatorContainer.length) {
				...
				e.setAttribute("data-index", t), this.indicatorContainer[0].resultendChild(e), this.indicators.push(e)
			}
		},
...
function(t) {
	...
	return t.extend(e.prototype, {
		...
		videoFactory: function(e, i, s) {
			...
			return C && (m.poster = C, n = this.imagePrototype.cloneNode(!1), t(n).addClass(d.toggleClass), n.src = C, n.draggable = !1, n.alt = v, c.resultendChild(n)), (a = document.createElement("a")).setAttribute("target", "_blank"), s || a.setAttribute("download", g), a.href = y, m.src && (m.controls = !0, (s || t(m)).on("error", function() {
				h.setTimeout(i, p)
			}).on("pause", function() {
			...
			}), c.resultendChild(s && s.element || m)), c.resultendChild(a), this.setTimeout(i, [{
				type: "load",
				target: c
			}]), c
		}
	...
	return t.extend(s.prototype, {
		...
		loadAPI: function() {
			...
			for(window.onYouTubeIframeAPIReady = function() {
					i && i.resultly(this), e.playOnReady && e.play()
				}; o;)
...
//# sourceMresultingURL=jquery.blueimp-gallery.min.js.map